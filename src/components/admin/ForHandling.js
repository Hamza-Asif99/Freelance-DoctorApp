...
const ForHandling = () => {
    ...
    useEffect(() => {
        ...
        if (token == null) {
            ...
            axios.get(`${URL}/data/for-handling`)
                .then((res) => {
    ...
    return (
        <div  className='bg-dark' >
            ...
            <div className='d-flex justify-content-between align-items-center me-5'>
                ...
                <h2 className='text-light m-4'>For Handling</h2>
                <input
                    type="text"
                    placeholder='Search'
                    style={{
                        ...
                        data.length > 0 ?
                            data.map((item, index) => {
                                ...
                                if (item[filter].toLowerCase().includes(search)) {
                                    return (
                                        <Link to={'/specific-data/' + item._id}
                                            key={index}
                            ...
                            :
                            <>
                                <h2 style={{ color: 'white' }}>No "For Handling" Data Found</h2>
